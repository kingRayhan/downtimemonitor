...
const workspaceInviteFilterKeyValidator = v.union(
...
type WorkspaceInviteFilterKey =
  typeof workspaceInviteFilterKeyValidator._type;

function applyOperator(
  q: any,
  key: WorkspaceInviteFilterKey,
...
export const findOne = query({
  args: {
    where: v.object({
      key: workspaceInviteFilterKeyValidator,
      value: v.any(),
  ...
  handler: async (ctx, { where }) => {
    ...
    const base = ctx.db.query("workspace_invites");
